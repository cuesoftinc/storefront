      ...
      <div className={styles.servicecontainer}>
        ...
        <div className={styles.servicesprovidedcontainer}>
          <div className={styles.content}>
            ...
            <div>
              <div>
                <h5 className={styles.servicetitle}>Original Products</h5>
              </div>
              <div>
          ...
          <div className={styles.content}>
            ...
            <div>
              <div>
                <h5 className={styles.servicetitle}>Satisfaction Guarantee</h5>
              </div>
              <div>
                <p className={styles.servicetext}>
                  We ensure money-back guarantee if the product is counterfeit
          ...
          <div className={styles.content}>
            ...
            <div>
              <div>
                <h5 className={styles.servicetitle}>New Arrival Everyday</h5>
              </div>
              <div>
                <p className={styles.servicetext}>
                  We ensure money-back guarantee if the product is counterfeit
          ...
          <div className={styles.content}>
            ...
            <div>
              <div>
                <h5 className={styles.servicetitle}>Fast & Free Shipping</h5>
              </div>
              <div>
                <p className={styles.servicetext}>
                  We ensure money-back guarantee if the product is counterfeit
